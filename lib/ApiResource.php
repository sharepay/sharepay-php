...
{
    private static $HEADERS_TO_PERSIST = array('SharePay-Account' => true, 'SharePay-Version' => true);

    public static function baseUrl()
    {
        return SharePay::$apiBase;
    }
    ...
    public static function className()
    {
        ...
        if (substr($class, 0, strlen('SharePay')) == 'SharePay') {
            $class = substr($class, strlen('SharePay'));
        }
    ...
    private static function _validateParams($params = null)
    {
        if ($params && !is_array($params)) {
            $message = "You must pass an array as the first argument to SharePay API "
               . "method calls.  (HINT: an example call to create a charge "
               . "would be: \"SharePay\\Charge::create(array('amount' => 100, "
    ...
    protected static function _all($params = null, $options = null)
    {
        ...
        return Util\Util::convertToSharePayObject($response, $opts);
    }
